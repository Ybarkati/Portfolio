...
optimizing performance, and driving impactful results. A collaborative team player known for problem-solving 
skills and a dedication to continuous learning            </p>
          </div>
          <div data-aos="fade-up" className="buttons flex gap-5">
            <a
              target="_blank"
              href="https://www.linkedin.com/in/yassine-barkati-b42aa9277/"
          ...
          <div className="icons flex mt-5">
            ...
            >
              <li>
                <a target="_blank" href="https://github.com/Ybarkati">
                  {" "}
                  <AiFillGithub className=" h-[1.8rem] w-[1.8rem] text-xl hover:scale-125" />{" "}
                </a>
              </li>
              <li>
                <a target="_blank" href="https://www.linkedin.com/in/yassine-barkati-b42aa9277/">
                  {" "}
                  <FaLinkedinIn className=" h-[1.8rem] w-[1.8rem] text-xl hover:scale-125 " />{" "}
                </a>
              </li>
              <li>
                <a target="_blank" href="https://instagram.com/yassine.barkati?utm_source=qr&igshid=NGExMmI2YTkyZg%3D%3D">
                  {" "}
                  <AiFillInstagram className=" h-[1.8rem] w-[1.8rem] text-xl hover:scale-125  " />{" "}
                </a>
              </li>
              <li>
                <a target="_blank" href="https://www.facebook.com/yassine.barkati.3">
                  {" "}
